...
import BlueCheckbox from "../../company/components/BlueCheckBox";
          ...
          >
            <div
              style={
                {
                  //   gap:'80%',
                  // border: "0.00.8vw solid rgba(46, 85, 169, 0.75)",
                  //  borderRadius: "50px",
                }
              }
            >
              ...
              <Dropdown
                ...
                value={buyerOption}
                onChange={(event) => SetBuyerOption(event.target.value)}
              />
              <Dropdown
                label="Commandes à l'exportation"
                options={exportOptions}
                value={exportOption}
                onChange={(event) => SetExportOption(event.target.value)}
              />
              <CustomButton
                sx={{ borderRadius: "50px" }}
                onClick={restParametres}
              >
                Supprimer
              </CustomButton>
            </div>
